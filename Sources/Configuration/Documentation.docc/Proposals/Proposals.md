...
For non-trivial changes that affect the public API, the Swift Configuration project adopts a lightweight version of the [Swift Evolution](https://github.com/apple/swift-evolution/blob/main/process.md) process.
